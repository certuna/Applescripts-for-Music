...
6. The script writes the tags. If you've chosen **Choose Genre**, it gives you a popup for each track to pick which Genre to apply (note: max 3 items - blame Apple since AppleScript dialog boxes max out at three buttons)
