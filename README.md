...
**Note 3** This is not a fast script, but Discogs only allows 60 requests per minute for their API, so it's intentionally slowed down somewhat. If you let this script loose on big selections, go grab a cup of coffee, walk your dog, look at cat pictures on the internet.
